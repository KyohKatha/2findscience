    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (mode.equals("upgrade")) {
                ...
                request.getSession().setAttribute("message", "<p>- Maximum <strong>number of upgrade</strong> requests altered!</p><p>- Click on the box to close it.</p>");
                ...
                if (!inserido) {
                    ...
                    request.getSession().setAttribute("type", "success");
                    request.getSession().setAttribute("message", "<p>- New <strong>theme</strong> inserted!</p><p>- Click on the box to close it.</p>");
                    rd = request.getRequestDispatcher("Filter?action=RequestUpgrade");
                }
            }
