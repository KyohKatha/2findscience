...
public class PublicationMaintenance extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getSession().setAttribute("message", "<p>- <strong>Error</strong> connection with database</p><p>- Click on the box to close it.</p>");
    ...
    private void savePublication(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            request.getSession().setAttribute("message", "<p>- <strong>Register publication</strong> successfully!</p><p>- Click on the box to close it.</p>");

        } catch (PublicationDAOException e) {
            request.getSession().setAttribute("type", "critical");
            request.getSession().setAttribute("message", "<p>- <strong>Error</strong> save data publication</p><p>- Click on the box to close it.</p>");
        }
        rd = request.getRequestDispatcher("/AjaxHomeAcademic.jsp");
    }
    ...
    private void updatePublication(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            request.getSession().setAttribute("type", "success");
            request.getSession().setAttribute("message", "<p>- <strong>Update publication</strong> successfully!</p><p>- Click on the box to close it.</p>");

        } catch (PublicationDAOException e) {
            request.getSession().setAttribute("type", "critical");
            request.getSession().setAttribute("message", "<p>- <strong>Error</strong> update data publication</p><p>- Click on the box to close it.</p>");
        }
        rd = request.getRequestDispatcher("/AjaxHomeAcademic.jsp");
    }
    ...
    private void deletePublication(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            request.getSession().setAttribute("type", "success");
            request.getSession().setAttribute("message", "<p>- <strong>Publication delete</strong> successfully!</p><p>- Click on the box to close it.</p>");

        } catch (PublicationDAOException e) {
            request.getSession().setAttribute("type", "critical");
            request.getSession().setAttribute("message", "<p>- <strong>Error</strong> delete publication</p><p>- Click on the box to close it.</p>");
        }
        rd = request.getRequestDispatcher("/AjaxHomeAcademic.jsp");
    }
   ...
   private void managePosts(HttpServletRequest request, HttpServletResponse response, int mode)
        ...
        try {
            if(mode == 1){
                ...
                request.getSession().setAttribute("type", "success");
                request.getSession().setAttribute("message", "<p>- Success inserting your <strong>post</strong>!</p><p>- Click on the box to close it.</p>");
            }else{
