...
// <editor-fold defaultstate="collapsed" desc="HttpServlet methods. Click on the + sign on the left to edit the code.">
    ...
    private void saveRegister(HttpServletRequest request, HttpServletResponse response, User newUser, String subjects)
        ...
        try {
            ...
            request.getSession().setAttribute("message", "<p>- Register successfully!</p><p>- Click on the box to close it.</p>");
    ...
    private void updateProfile(HttpServletRequest request, HttpServletResponse response, User newUser, String subjects)
        ...
        try {
            ...
            request.getSession().setAttribute("type", "success");
            request.getSession().setAttribute("message", "<p>- Register update successfully!</p><p>- Click on the box to close it.</p>");
        } catch (PublicationDAOException e) {
            request.getSession().setAttribute("type", "critical");
            request.getSession().setAttribute("message", "<p>- <strong>Error</strong> with connection database</p><p>- Click on the box to close it.</p>");
        }
        if (profile.equals("admin")) {
            rd = request.getRequestDispatcher("/AjaxHomeAdmin.jsp");
        } else {
    ...
    private void save(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getSession().setAttribute("type", "success");
            request.getSession().setAttribute("message", "<p>- <strong>User</strong> saved successfully </p>");
