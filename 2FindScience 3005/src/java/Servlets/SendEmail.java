...
public class SendEmail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Transport t = session.getTransport("smtps"); //= session.getTransport("smtps");
            try {
            ...
            request.getSession().setAttribute("message", "<p>- <strong>Message</strong> sent was successfull!</p><p>- Click on the box to close it.</p>");
            ...
            request.getSession().setAttribute("message", "<p>- Error while sendind the <strong>message</strong>!</p><p>- Click on the box to close it.</p>");
            e.printStackTrace();
            RequestDispatcher rd = null;
